...
#  Very many thanks, Pater! ( Btw, just to let you know - I am the 
#  Andy who asked about this code in the comments at the bottom of 
#  the above page... )   

#  Peter did say of this code that "for my main use. it is too slow." 
#  However, it is an excellent example of monadic parsing and I had to 
#  include it in my repo...... :)  
...
### NOTE BY ANDY - I am pretty sure that pysec.py ends here.  
### If the example below is cut out and saved as json-example.py 
### and then run, it should work.  
