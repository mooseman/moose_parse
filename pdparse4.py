...
class parser(object): 
    ...
    #  E.g. "foo", add, ["this", "is", "a", "test"]    
    def add(self, rulename, ruletype, tokenlist): 
       self.ruledict.update({rulename: ruletype, tokenlist})  
       
    def match(self, rulename, stmt): 
       if self.ruledict.has_key(rulename): 
